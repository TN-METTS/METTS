function M = tmp_CPS_collapse(M, print_log)
% CPS = CPS_collapse(M,print_log) 
%
...
for it = (1:N)
    ...
    for it2 = (1:dim)
        ...
        prob(it2) = contract(Tmp, 3, (1:3), conj(Tmp), 3,(1:3));
    end
    ...
    M{it} = contract(M{it}, 3, 3, diag(C{idx}), 2, 2)./sqrt(prob(idx));
